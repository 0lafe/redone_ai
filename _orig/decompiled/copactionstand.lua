...
function CopActionStand.init(arg_1_0, arg_1_1, arg_1_2)
	...
	if var_1_0.move then
		...
		if var_1_0.run_start_turn then
			var_1_2 = arg_1_2.ext_movement._actions.walk._walk_anim_lengths.stand[arg_1_2.stance.name].run_start_turn[var_1_0.move_side]
		elseif var_1_0.run_start then
			var_1_2 = arg_1_2.ext_movement._actions.walk._walk_anim_lengths.stand[arg_1_2.stance.name].run_start[var_1_0.move_side]
		elseif var_1_0.run_stop then
			var_1_2 = arg_1_2.ext_movement._actions.walk._walk_anim_lengths.stand[arg_1_2.stance.name].run_stop[var_1_0.move_side]
		else
			var_1_2 = arg_1_2.ext_movement._actions.walk._walk_anim_lengths
			var_1_2 = var_1_2 and var_1_2.stand[arg_1_2.stance.name]
	...
	if arg_1_2.ext_movement:play_redirect("stand", var_1_1) then
		if not arg_1_1.syncless and Network:is_server() then
			arg_1_2.ext_network:send("set_pose", 1)
		end
